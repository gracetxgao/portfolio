    ...
    return (
        <Box paddingInline={10}>
            ...
            <p style={{ paddingLeft: '30px', fontSize: '150%', color: textColor}}>
                I'm a computer science and mathematics student at the University of British Columbia who loves creating things, whether it's a cool coding project or another crochet piece :)
